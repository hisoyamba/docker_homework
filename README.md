...
> Пет-проект: ETL-пайплайн с двумя PostgreSQL базами в Docker

---

## 📋 Описание

Проект демонстрирует классический ETL-пайплайн:

- **Extract** — Python читает витрину данных из исходной БД
- **Transform** — данные уже агрегированы в витрине через SQL
- **Load** — Python заливает данные в целевую БД
